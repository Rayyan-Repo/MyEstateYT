...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="tel" name="name" maxlength="50" placeholder="<?= isset($fetch_user['name']) ? $fetch_user['name'] : 'enter your name'; ?>" class="box">
      <input type="email" name="email" maxlength="50" placeholder="<?= isset($fetch_user['email']) ? $fetch_user['email'] : 'enter your email'; ?>" class="box">
      <input type="number" name="number" min="0" max="9999999999" maxlength="10" placeholder="<?= isset($fetch_user['number']) ? $fetch_user['number'] : 'enter your number'; ?>" class="box">
